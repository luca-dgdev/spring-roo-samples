...
privileged aspect PizzaOrderController_Roo_Controller_Json {
    ...
    public ResponseEntity<String> PizzaOrderController.createFromJson(@RequestBody String json, UriComponentsBuilder uriBuilder) {
        HttpHeaders headers = new HttpHeaders();
        ...
        try {
            ...
            headers.add("Location",uriBuilder.path(a.value()[0]+"/"+pizzaOrder.getId().toString()).build().toUriString());
