...
privileged aspect Pet_Roo_JavaBean {
     ...
     * @return Pet
     */
    public Pet Pet.setVisits(Set<Visit> visits) {
        this.visits = visits;
        return this;
    }
     ...
     * @return Pet
     */
    public Pet Pet.setCreatedDate(Calendar createdDate) {
     ...
     * @return Pet
     */
    public Pet Pet.setCreatedBy(String createdBy) {
     ...
     * @return Pet
     */
    public Pet Pet.setModifiedDate(Calendar modifiedDate) {
     ...
     * @return Pet
     */
    public Pet Pet.setModifiedBy(String modifiedBy) {
