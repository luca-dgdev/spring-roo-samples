...
privileged aspect PetsCollectionThymeleafController_Roo_Thymeleaf {
     ...
     * 
     */
    private MessageSource PetsCollectionThymeleafController.messageSource;
     ...
     * 
     */
    private MethodLinkBuilderFactory<PetsCollectionThymeleafController> PetsCollectionThymeleafController.collectionLink;
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private ConversionService PetsCollectionThymeleafController.conversionService;
     ...
     */
    @Autowired
    public PetsCollectionThymeleafController.new(PetService petService, ConversionService conversionService, MessageSource messageSource, ControllerMethodLinkBuilderFactory linkBuilder) {
     ...
     */
    public MessageSource PetsCollectionThymeleafController.getMessageSource() {
        return messageSource;
    }
     ...
     * @param messageSource
     */
    public void PetsCollectionThymeleafController.setMessageSource(MessageSource messageSource) {
     ...
     */
    public MethodLinkBuilderFactory<PetsItemThymeleafController> PetsCollectionThymeleafController.getItemLink() {
        return itemLink;
    }
     ...
     * @param itemLink
     */
    public void PetsCollectionThymeleafController.setItemLink(MethodLinkBuilderFactory<PetsItemThymeleafController> itemLink) {
     ...
     * @return MethodLinkBuilderFactory
     */
    public MethodLinkBuilderFactory<PetsCollectionThymeleafController> PetsCollectionThymeleafController.getCollectionLink() {
     ...
     */
    public void PetsCollectionThymeleafController.setCollectionLink(MethodLinkBuilderFactory<PetsCollectionThymeleafController> collectionLink) {
     ...
     */
    public ConversionService PetsCollectionThymeleafController.getConversionService() {
        return conversionService;
    }
     ...
     * @param conversionService
     */
    public void PetsCollectionThymeleafController.setConversionService(ConversionService conversionService) {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<Pet>> PetsCollectionThymeleafController.datatables(DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<Pet>> PetsCollectionThymeleafController.datatablesByIdsIn(@RequestParam("ids") List<Long> ids, DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
    ...
    @ResponseBody
    public ResponseEntity<Select2DataSupport<Pet>> PetsCollectionThymeleafController.select2(GlobalSearch search, Pageable pageable, Locale locale) {
        Page<Pet> pets = getPetService().findAll(search, pageable);
    ...
    @ResponseBody
    public ResponseEntity<?> PetsCollectionThymeleafController.deleteBatch(@PathVariable("ids") Collection<Long> ids) {
     ...
     */
    public void PetsCollectionThymeleafController.export(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, String[] datatablesColumns, HttpServletResponse response, JasperReportsExporter exporter, String fileName, Locale locale) {
    ...
    @ResponseBody
    public ResponseEntity<?> PetsCollectionThymeleafController.exportCsv(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
    ...
    @ResponseBody
    public ResponseEntity<?> PetsCollectionThymeleafController.exportPdf(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
    ...
    @ResponseBody
    public ResponseEntity<?> PetsCollectionThymeleafController.exportXls(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
     ...
     */
    public void PetsCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        try {
