...
privileged aspect VetsCollectionThymeleafController_Roo_Thymeleaf {
     ...
     * 
     */
    private MethodLinkBuilderFactory<VetsCollectionThymeleafController> VetsCollectionThymeleafController.collectionLink;
     ...
     * @return MethodLinkBuilderFactory
     */
    public MethodLinkBuilderFactory<VetsCollectionThymeleafController> VetsCollectionThymeleafController.getCollectionLink() {
     ...
     */
    public void VetsCollectionThymeleafController.setCollectionLink(MethodLinkBuilderFactory<VetsCollectionThymeleafController> collectionLink) {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<VetInfo>> VetsCollectionThymeleafController.datatablesByIdsIn(@RequestParam("ids") List<Long> ids, DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
        Page<VetInfo> vets = getVetService().findAllByIdsIn(ids, search, pageable);
        long totalVetsCount = vets.getTotalElements();
        if (search != null && StringUtils.isNotBlank(search.getText())) {
            totalVetsCount = getVetService().count();
        }
