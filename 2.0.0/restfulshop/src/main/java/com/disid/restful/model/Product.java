...
public class Product {
    ...
    @JoinTable(name = "my_products_categories", joinColumns = { @JoinColumn(name = "my_product", referencedColumnName = "id") }, inverseJoinColumns = { @JoinColumn(name = "my_category", referencedColumnName = "id") })
