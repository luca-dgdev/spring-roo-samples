...
import com.disid.restful.web.CustomerOrdersItemThymeleafController;
import com.disid.restful.web.CustomerOrdersItemThymeleafLinkFactory;
...
privileged aspect CustomerOrdersCollectionThymeleafController_Roo_Thymeleaf {
     ...
     * 
     */
    private MethodLinkBuilderFactory<CustomerOrdersCollectionThymeleafController> CustomerOrdersCollectionThymeleafController.collectionLink;
     ...
     * @return MethodLinkBuilderFactory
     */
    public MethodLinkBuilderFactory<CustomerOrdersCollectionThymeleafController> CustomerOrdersCollectionThymeleafController.getCollectionLink() {
     ...
     */
    public void CustomerOrdersCollectionThymeleafController.setCollectionLink(MethodLinkBuilderFactory<CustomerOrdersCollectionThymeleafController> collectionLink) {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<CustomerOrder>> CustomerOrdersCollectionThymeleafController.datatablesByIdsIn(@RequestParam("ids") List<Long> ids, DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
    ...
    public void CustomerOrdersCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        ...
        if (columnName.equals("id")) {
            ...
            builder.addColumn(getMessageSource().getMessage("label_customerorder_orderdate", null, "Order Date", locale), "orderDate", Date.class.getName(), 100);
        }
        else if (columnName.equals("shippedDate")) {
            builder.addColumn(getMessageSource().getMessage("label_customerorder_shippeddate", null, "Shipped Date", locale), "shippedDate", Date.class.getName(), 100);
        }
