...
privileged aspect CategoriesCollectionJsonController_Roo_JSON {
    ...
    declare @type: CategoriesCollectionJsonController: @RequestMapping(value = "/categories", name = "CategoriesCollectionJsonController", produces = MediaType.APPLICATION_JSON_VALUE);
