...
import com.disid.restful.web.ProductsCollectionThymeleafLinkFactory;
...
privileged aspect ProductsCollectionThymeleafLinkFactory_Roo_LinkFactory {
     ...
     * 
     */
    public static final String ProductsCollectionThymeleafLinkFactory.DATATABLESBYIDSIN = "datatablesByIdsIn";
