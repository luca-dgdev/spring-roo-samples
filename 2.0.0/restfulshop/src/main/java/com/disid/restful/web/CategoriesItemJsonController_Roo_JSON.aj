...
privileged aspect CategoriesItemJsonController_Roo_JSON {
    ...
    declare @type: CategoriesItemJsonController: @RequestMapping(value = "/categories/{category}", name = "CategoriesItemJsonController", produces = MediaType.APPLICATION_JSON_VALUE);
